    ...
    <footer className="max-container">
      ...
      flex-wrap max-lg:flex-col">
        <div className="flex flex-col items-start">
          ...
          <p className="mt-6 text-base leading-7 text-montserrat
          ...
          ">
            {socialMedia.map((icon, index) => (
              ...
              w-12 h-12 bg-white rounded-full" key={index}>
      ...
      <div className="fleex justify-between text-white-400
      mt-24 max-sm:flex-col max-sm:items-center">
        ...
        cursor-pointer mt-2">Terms & Conditions</p>
      </div>
    </footer>
  )
}
